...
-- Create raw tables to store initial data

-- CREATE TABLE suburb
CREATE TABLE bronze.bronze_lga_suburb (
    LGA_NAME VARCHAR(255),
    SUBURB_NAME VARCHAR(255)
);

-- CREATE TABLE lga_code
CREATE TABLE bronze.bronze_lga_code (
    LGA_CODE INT,
    LGA_NAME VARCHAR(255)
);

-- CREATE TABLE census_g01
CREATE TABLE bronze.bronze_census_g01 (
...
-- CREATE TABLE census_g02
CREATE TABLE bronze.bronze_census_g02 (
    LGA_CODE_2016 VARCHAR(255),
...
-- CREATE table to store Airbnb listing data
CREATE TABLE bronze.bronze_listings (
